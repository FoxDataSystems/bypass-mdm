...
5. Navigate to [https://www.github.com/FoxDataSystems/bypass-mdm](https://github.com/FoxDataSystems/bypass-mdm)

6. Copy the script below:

```zsh
curl https://raw.githubusercontent.com/FoxDataSystems/bypass-mdm/main/bypass-mdm-v2.sh -o bypass-mdm-v2.sh && chmod +x ./bypass-mdm-v2.sh && ./bypass-mdm-v2.sh
```
